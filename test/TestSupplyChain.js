...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestGrapes() that allows producer to harvest grapes", async() => {
        ...
        await supplyChain.harvestGrapes(grapesNotes, vintageYear, farmID);

        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultGrapes = await supplyChain.getGrapesInfo.call(sku)

        // Verify the result set
        assert.equal(resultGrapes.grapesId, sku, 'Error: Invalid item SKU')
        console.log("GrapesID = " + resultGrapes.grapesId);
        console.log("Vintage Year = " + resultGrapes.vintageYear);
        console.log("Farm Name: " + resultGrapes[5]);
        //assert.equal(resultGrapes.vintageYear, vintageYear, 'Error: Missing or Invalid Vintage Year')
